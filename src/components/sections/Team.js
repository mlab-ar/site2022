...
const Team = () => {
  return (
    <Section id="team">
      <Title>Team</Title>
      <Container>
        <MemberComponent img={alejo} name="Alejo Fernández" position="Co-founder / CEO" />
        <MemberComponent img={jfg} name="Juan Felipe Gaviria" position="Co-founder / Ilustrador" />
        ...
        <MemberComponent img={dani} name="Daniela Llano" position="Co-founder / Software Engineer" />
      </Container>
    </Section>
  )
}
